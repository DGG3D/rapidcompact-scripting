...
A python scripting tool for the [RapidCompact REST API](http://rapidcompact.com/doc/restapi/documentation/index.html), based on Python and acting as a command line tool.
